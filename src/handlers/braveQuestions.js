...
import braveQuestionsHelper from '../helpers/braveQuestionsHelper'
import errorPage from '../templates/error'

const braveQuestions = async (req) => {
  ...
  try{
    if(q){
      let payload = {}
      payload.questions = await braveQuestionsHelper(q,o)
      payload.query = []
