import braveAlphabeticalHelper from '../helpers/braveAlphabeticalHelper'
import errorPage from '../templates/error'

const braveAlphabetical = async (req) => {
  // q = query
  ...
  try{
    if(q){
      let payload = {}
      payload.alphabetical = await braveAlphabeticalHelper(q,o)
      payload.query = []
...
export default braveAlphabetical